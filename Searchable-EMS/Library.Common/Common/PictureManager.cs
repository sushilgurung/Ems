...
namespace Library.Common
{
    public static class PictureManager
    {
        ...
        public static void CreateThmnail(string strImage, int TargetSize, string SavePath, bool isZoomThumbnail)
        {
            ...
            if (isZoomThumbnail)
            {
                newSize.Width = SystemSetting.ZOOM_THUMBNAIL_WIDTH;
                newSize.Height = SystemSetting.ZOOM_THUMBNAIL_HEIGHT;
            }
        ...
        public static string CreateMediumThumnail(string strImage, int PortalID, string prefix, string localImagePath, int imageSize)
        {
            ...
            //int imageSize = 200;
            CreateThmnail(strImage, imageSize, SavePath, false);
            return SavePath;
        }
